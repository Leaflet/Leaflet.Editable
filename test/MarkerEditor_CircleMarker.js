...
describe('L.MarkerEditor using L.CircleMaker', function() {
    var p2ll;
    ...
    describe('#startNewMarker()', function() {
        ...
        it('should create feature and editor', function() {
            marker = this.map.editTools.startMarker(null, {markerClass: L.CircleMarker});
            assert.ok(marker);
    ...
    describe('#enable()', function () {
        ...
        it('should start editing on enable() call', function () {
            var marker = L.circleMarker([0, 0]).addTo(this.map);
            marker.enableEdit();
            assert.ok(marker.editor);
        });
    ...
    describe('#events', function () {
        ...
        it('should fire editable:drawing:start on startMarker call', function () {
            ...
            var other = this.map.editTools.startMarker(null, {markerClass: L.CircleMarker});
